"""Config flow for Samsung TV Smart with OAuth2 support."""
...
class SamsungTVSmartOAuth2FlowHandler(
    ...
    """Handle Samsung TV Smart config flow with OAuth2 support."""
    ...
    def _apply_reconfigure_and_reload(self) -> ConfigFlowResult:
        ...
        updates = {
            ...
            # Drop any REST/Art ports learned for the previous connection so they
            # re-learn from the freshly chosen port instead of keeping a stale
